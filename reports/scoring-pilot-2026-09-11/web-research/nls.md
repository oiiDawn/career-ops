...
2026-09-11 外部研究更新；JD仍为历史快照。正式队列未修改。
...
sources:
  ...
  - id: rules
    path: reports/scoring-pilot-2026-09-11/web-research/rules.md
    sha256: abd2043fce06faeb4d77e9ade83f5288c9c6782a9e455dd4038e872ff283b492
  - id: research
    path: reports/scoring-pilot-2026-09-11/web-research/nls.json
    sha256: d26fc5425451290337b0bfac001e1d5d3073e5631479ac5c2b5b949486e3c781
  - id: market
    path: reports/scoring-pilot-2026-09-11/web-research/market.md
...
dimensions:
  ...
  compensation:
    score: null
    rationale: 历史JD只有最高100万HKD；市场中位102万HKD并不能证明候选人可得底薪，Unknown。
    evidence:
      - source: nls
  ...
  team:
    score: null
    rationale: 历史JD提弹性混合办公；新搜索命中同招聘帖，但打开失败，不能视为新正文验证。雇主匿名，无法对应员工工时与管理反馈，Unknown。
    evidence:
      - source: nls
  ...
  company:
    score: null
    rationale: 实际雇主仍匿名；不能把NLS招聘代理人数或口碑移给客户，也不能猜为A2B2。需要客户名称才能继续有针对性的经营研究，Unknown。
    evidence:
      - source: nls
...
| compensation | Unknown | 30% | 历史JD只有最高100万HKD；市场中位102万HKD并不能证明候选人可得底薪，Unknown。 |
| team | Unknown | 25% | 历史JD提弹性混合办公；新搜索命中同招聘帖，但打开失败，不能视为新正文验证。雇主匿名，无法对应员工工时与管理反馈，Unknown。 |
| company | Unknown | 10% | 实际雇主仍匿名；不能把NLS招聘代理人数或口碑移给客户，也不能猜为A2B2。需要客户名称才能继续有针对性的经营研究，Unknown。 |
...
已执行的查询、来源范围与剩余问题见[研究日志](nls.json)。三个维度均已主动检索；没有找到充分资料不等于无风险。
