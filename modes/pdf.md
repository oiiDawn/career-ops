...
Never mutate `cv.md` or the configured Reactive Resume mother resume. Reactive Resume remains the backend: it duplicates and patches the application-specific managed copy only. Pipeline roles require explicit `Proceed` before this bundle is generated.
